    ...
    <div className="bg-linear-to-r from-graphite to-gray-800 text-white">
      <div className="container-custom py-16">
        <div className="max-w-4xl">
          <div className="h-12 bg-white/10 rounded-sm mb-6 animate-pulse"></div>
          <div className="h-6 bg-white/10 rounded-sm mb-8 w-3/4 animate-pulse"></div>
  ...
  loading: () => (
    <div className="container-custom py-16">
      <div className="max-w-4xl mx-auto">
        <div className="h-10 bg-gray-200 rounded-sm mb-8 w-1/3 mx-auto animate-pulse"></div>
        <div className="space-y-4">
          <div className="h-6 bg-gray-200 rounded-sm animate-pulse"></div>
          <div className="h-6 bg-gray-200 rounded-sm w-5/6 animate-pulse"></div>
          <div className="h-6 bg-gray-200 rounded-sm w-4/6 animate-pulse"></div>
        </div>
      </div>
    </div>
  )
    ...
    <div className="bg-gray-50 py-16">
      <div className="container-custom">
        <div className="text-center mb-16">
          <div className="h-10 bg-gray-200 rounded-sm mb-4 w-1/3 mx-auto animate-pulse"></div>
          <div className="h-6 bg-gray-200 rounded-sm w-2/3 mx-auto animate-pulse"></div>
        </div>
